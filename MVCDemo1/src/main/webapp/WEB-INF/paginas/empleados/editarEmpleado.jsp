...
<html>
    <head>
        ...
        <script src="https://kit.fontawesome.com/4feef18548.js" crossorigin="anonymous"></script>
                        ...
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="saldo">Salario</label>
                                        <input type="number" class="form-control" name="saldo" required value="${empleado.salario}" step="any">
                                    </div>
                                </div>
                            </div>
                        </div>
